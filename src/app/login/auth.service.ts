...
export class AuthService implements OnInit {
  ...
  public login(inputEmail: string, inputPassword: string): Observable<User> {
    ...
    return this.http.get<User>('https://restaurant-frontend-git-master.dudesup.vercel.app/login/' + inputEmail,
      {
        params: {
  ...
  public logout() {
    ...
    this.router.navigate(['https://restaurant-frontend-git-master.dudesup.vercel.app/login']);
